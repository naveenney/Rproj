...
class Person
{
	...
	public static void bmiComparison(Person[] list)
	{
		System.out.println("\nBMI reports in decending Order:");
...
public class BmiCompare {
	...
	public static void main(String[] args)
	{
		...
		int n=scan.nextInt();
         ...
         for(int i=0;i<n;i++)
         {
        	 System.out.print("\nenter the person "+(i+1)+" name:");
        	 String name=scan.next();
        	 
        	 System.out.print("\nenter the person "+(i+1)+" Weight:");
        	 float weight=scan.nextFloat();
        	 
        	 System.out.print("\nenter the person "+(i+1)+" height:");
